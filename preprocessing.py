...
class Ui_Preprocessing(object):
    def setupUi(self, Preprocessing):
        ...
        self.gridLayout.addWidget(self.txtLog, 10, 0, 1, 4)
    ...
    def retranslateUi(self, Preprocessing):
        ...
        self.listDataPaths.setToolTip(_translate("Preprocessing", "<html><head/><body><p align=\"justify\">List of paths to folders containing images and/or labels.</p></body></html>"))
